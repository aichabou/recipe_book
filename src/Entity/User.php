...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user_id', targetEntity: FavoriteRecipe::class)]
    ...
    public function removeFavoriteRecipe(FavoriteRecipe $favoriteRecipe): self
    {
        if ($this->favoriteRecipes->removeElement($favoriteRecipe)) {
            ...
            if ($favoriteRecipe->getUserId() === $this) {
                $favoriteRecipe->setUserId(null);
            }
        }
